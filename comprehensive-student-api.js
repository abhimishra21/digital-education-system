...
//         // Create a fresh gateway connection with custom timeout
//         const client = await newGrpcConnection();   // your existing helper
//         const identity = await newIdentity();       // your existing helper
//         const signer = await newSigner();           // your existing helper
